...
import { Ruler, Thermometer, Weight, FlaskConical, Copy, Check } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto p-3">
        <div className="flex items-center gap-2 mb-3">
          ...
          <select
            ...
            className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-sm focus:outline-none focus:border-green-500"
          >
          ...
          {allResults.map(({ unit, value }) => (
            ...
            >
              ...
              <button
                ...
                className="mt-1 p-1 rounded bg-white dark:bg-gray-600 border border-gray-200 dark:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-500 transition-colors"
                title="复制"
              >
